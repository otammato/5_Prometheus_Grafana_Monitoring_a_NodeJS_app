...
This time I will set up the scraping of the default metrics and will be using the standard Grafana dashboards. However, in upcoming projects I plan setting up scraping of "RED" or "USE" metrics following this approach:
